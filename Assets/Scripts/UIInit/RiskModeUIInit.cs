...
public class RiskModeUIInit : IUIInit
{
    protected override void UIEventInit()
    {
        ...
        transform.GetChild(0).GetComponent<Button>().onClick.AddListener(delegate () { mUISystem.UIHideButton("RiskModeUI"); FindObjectOfType<AudioSystem>().PlayButtonAudio(); });
