...
public class SimpleModeUIInit : IUIInit
{
    protected override void UIEventInit()
    {
        ...
        transform.GetChild(0).GetComponent<Button>().onClick.AddListener(delegate () { mUISystem.UIHideButton("SimpleModeUI"); FindObjectOfType<AudioSystem>().PlayButtonAudio(); });
